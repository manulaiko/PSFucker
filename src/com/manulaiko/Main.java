...
public class Main
{
    ...
    {
        fingerprinters.put("OrbitReborn", new com.manulaiko.fingerprinters.OrbitReborn());
        fingerprinters.put("Global", new com.manulaiko.fingerprinters.Global());
    }
